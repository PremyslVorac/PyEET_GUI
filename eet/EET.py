...
class EET:
    ...
    def __init__(self, cert_file, password, outdir, provozovna=1, pokladna='pokladna1',
                 testing=True, eet_url='https://pg.eet.cz:443/eet/services/EETServiceSOAP/v3'):
    ...
    def send_payment(self, payment):
        ...
        open(self._outdir + '\\eet_out.xml', 'wb').write((soap_string))
